...
public final class Constants {
    ...
    // TODO: I based this off of the gear tooth ratios, but don't know if that's right
    ...
    // The amount of the max speed to start ramping with autonomous turning, from 0 to 1
    public static final double autoDriveMinRampTurnSpeed = 0.6;
    // The amount to shift the peak of the ramping with autonomous turning. -1 moves the peak to the start, 0 leaves it in the middle, and 1 moves the peak to the end
    ...
    // The acceptable distance from the target angle for autonomous turning, in degrees
