...
public class Pixy extends SubsystemBase {
  ...
  public Block getBiggestBlock() {
    ...
    //blocks = pixy.getCCC().getBlocks(); // Gets a list of all blocks found by the Pixy2
  ...
  public void periodic() {
    ...
    if (loadedblock != null) {
      ...
      System.out.println("ballwidth : " + ballwidth + "; ballHeight : " + ballheight + "; ballx : " + ballx +"; bally : " + ballY + "; ballangle : " + ballAngle);
    }
  }
